...
Java_com_silver_fox_media_rtmp_CameraLive_connect(JNIEnv *env, jobject thiz, jstring url_) {
...
Java_com_silver_fox_media_rtmp_CameraLive_disconnect(JNIEnv *env, jobject thiz) {
    if (live) {
        if (live->rtmp) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_silver_fox_media_rtmp_ScreenLive_connect(JNIEnv *env, jobject thiz, jstring url_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_silver_fox_media_rtmp_ScreenLive_disconnect(JNIEnv *env, jobject thiz) {
    if (live) {
        if (live->rtmp) {
            RTMP_Close(live->rtmp);
            RTMP_Free(live->rtmp);
